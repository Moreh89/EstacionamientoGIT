...
public class GestionDescuento extends JDialog implements ActionListener, ListSelectionListener {
	...
	public GestionDescuento() {
		...
		aceptarButton.setIcon(new ImageIcon(GestionDescuento.class.getResource("/image/ok.png")));
		...
		btnAgregarColor.setIcon(new ImageIcon(GestionDescuento.class.getResource("/image/plus.png")));
		...
		btnModificarColor.setIcon(new ImageIcon(GestionDescuento.class.getResource("/image/modificar.png")));
