...
public class ModificarVehiculo extends JFrame implements ActionListener{
	...
	public ModificarVehiculo(AltaCliente altaCliente) {
		...
		textFieldPatente = new JTextField(altaCliente.getSelectedVehiuclo().getPatente());
		...
		textFieldObservacion = new JTextField(altaCliente.getSelectedVehiuclo().getComentario());
		...
		btnCrearVehiculo = new JButton("Actualizar");
	...
	public void actionPerformed(ActionEvent event) {
		...
		if(event.getSource()==btnCrearVehiculo)
		{
			...
			modelo.Vehiculo v = altaCliente.getSelectedVehiuclo();
			v.setCategoria((CategoriaVehiculo)comboBoxCategoriaVehiculo.getSelectedItem());
			v.setColor((ColorVehiculo)comboBoxColor.getSelectedItem());
			v.setComentario(textFieldObservacion.getText());
			v.setModelo((ModeloVehiculo)comboBoxModelo.getSelectedItem());
			v.setPatente(textFieldPatente.getText());
		
			altaCliente.actualizarVehiculo(v);
			dispose();
